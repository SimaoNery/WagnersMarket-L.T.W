...
-- Populate ITEM table
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (2, 'Striped T-shirt', 15.99, 'Classic black and white striped t-shirt.', 'Very Good', 'M', 'Nike', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (2, 'Skinny Jeans', 29.99, 'Blue denim skinny jeans.', 'Good', 'S', 'Levi''s', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (3, 'Floral Dress', 39.99, 'Flowy floral print dress.', 'Excellent/Like New', 'L', 'Zara', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (3, 'Hooded Jacket', 49.99, 'Black hooded jacket for casual wear.', 'Fair', 'M', 'Adidas', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (4, 'Plaid Shirt', 19.99, 'Casual plaid shirt for everyday wear.', 'Very Good', 'S', 'Gap', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (4, 'Denim Shorts', 24.99, 'Classic denim shorts for summer.', 'Good', 'M', 'Old Navy', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (4, 'Striped Sweater', 34.99, 'Cozy striped sweater for chilly days.', 'Very Good', 'L', 'H&M', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (5, 'Maxi Skirt', 29.99, 'Long flowy skirt for a bohemian look.', 'Excellent/Like New', 'M', 'Forever 21', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (5, 'Polo Shirt', 22.99, 'Classic polo shirt for a preppy style.', 'Good', 'L', 'Ralph Lauren', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (5, 'Cargo Pants', 39.99, 'Functional cargo pants with multiple pockets.', 'Fair', 'S', 'Columbia', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (6, 'Leather Jacket', 99.99, 'Stylish leather jacket for a timeless look.', 'Good', 'M', 'Guess', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (6, 'Ruffle Blouse', 27.99, 'Feminine ruffle blouse with floral print.', 'Very Good', 'L', 'Zara', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (6, 'Athletic Leggings', 19.99, 'Stretchy athletic leggings for workouts.', 'Good', 'S', 'Nike', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (2, 'Graphic T-shirt', 14.99, 'Cool graphic print t-shirt for casual wear.', 'Very Good', 'M', 'Urban Outfitters', '../images/striped_tshirt.webp');
...
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (2, 'V-neck Sweater', 39.99, 'Soft v-neck sweater for a cozy feel.', 'Very Good', 'M', 'Gap', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (2, 'Chino Pants', 34.99, 'Classic chino pants for a polished look.', 'Good', 'L', 'Dockers', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (3, 'Wrap Dress', 49.99, 'Versatile wrap dress for any occasion.', 'Excellent/Like New', 'S', 'H&M', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (3, 'Parka Jacket', 79.99, 'Stylish parka jacket for winter warmth.', 'Good', 'XL', 'The North Face', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (4, 'Crop Top', 19.99, 'Trendy crop top for a fashionable look.', 'Very Good', 'S', 'Forever 21', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (4, 'Cargo Shorts', 29.99, 'Cargo shorts with plenty of pockets.', 'Good', 'M', 'American Eagle', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (4, 'Hoodie', 44.99, 'Comfy hoodie for casual days.', 'Very Good', 'L', 'Old Navy', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (5, 'Ankle Boots', 59.99, 'Stylish ankle boots for everyday wear.', 'Excellent/Like New', 'M', 'Steve Madden', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (5, 'Button-down Shirt', 24.99, 'Classic button-down shirt for a smart look.', 'Good', 'L', 'Banana Republic', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (5, 'Cargo Jacket', 69.99, 'Functional cargo jacket for outdoor adventures.', 'Fair', 'S', 'Patagonia', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (6, 'Boho Dress', 54.99, 'Bohemian-style dress for a free-spirited vibe.', 'Good', 'M', 'Free People', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (6, 'Distressed Jeans', 44.99, 'Trendy distressed jeans for a casual look.', 'Very Good', 'L', 'American Eagle', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (6, 'Sneakers', 79.99, 'Versatile sneakers for everyday comfort.', 'Excellent/Like New', 'S', 'Nike', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (2, 'Graphic Hoodie', 34.99, 'Cool graphic print hoodie for a trendy look.', 'Good', 'M', 'Hollister', '../images/striped_tshirt.webp');
INSERT INTO ITEM (UserId, Title, Price, Description, Condition, Size, Brand, ImagePath) VALUES (3, 'Leather Boots', 89.99, 'Classic leather boots for timeless style.', 'Excellent/Like New', 'L', 'Timberland', '../images/striped_tshirt.webp');
