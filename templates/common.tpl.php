        ...
        <header>
            ...
            <section class="header-right">
                <ul>
                    ...
                    <li><a href="#">Sell</a></li>
                    <li>
                        <a href="../pages/profile.php?id=<?= $session->getId() ?>">Profile</a>
                        <?php
                    ...
                    <li><a href="../pages/messages.php?id=<?= $session->getId() ?>">Messages</a></li>
                    <li><a href="../pages/wishlist.php?id=<?= $session->getId() ?>"><i class="fas fa-heart"></i></a></li>
                    <li><a href="../pages/shopping-bag.php?id=<?= $session->getId() ?>"><i class="fas fa-shopping-bag"></i></a></li>
